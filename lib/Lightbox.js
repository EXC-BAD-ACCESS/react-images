...
var Lightbox = function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		value: function preloadImageData(data, onload) {
			...
			var thumbnailsSize = this.props.showThumbnails ? this.theme.thumbnail.size : 0;
			...
			var img = this.props.customPreloadImage(data, onload, widthOffset, heightOffset);
			if (img) return img;
		...
		value: function renderImages() {
			...
			var figureClassName = (0, _aphrodite.css)(this.classes.figure);
			var imgClassName = (0, _aphrodite.css)(this.classes.image, imageLoaded && this.classes.imageLoaded);

			return customImage(image, imageLoaded, figureClassName, imgClassName, onClickImage, widthOffset, heightOffset) || _react2.default.createElement(
				'figure',
...
Lightbox.propTypes = {
	...
	customImage: _propTypes2.default.func,
	customPreloadImage: _propTypes2.default.func,
...
Lightbox.defaultProps = {
	...
	customPreloadImage: function customPreloadImage() {},
